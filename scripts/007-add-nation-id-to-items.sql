-- Add nation_id field to items table to link items to nations
ALTER TABLE items ADD COLUMN IF NOT EXISTS nation_id INTEGER;

-- Add foreign key constraint to link items to nations
ALTER TABLE items ADD CONSTRAINT IF NOT EXISTS fk_items_nation_id 
